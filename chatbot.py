...
option = st.sidebar.selectbox("Choose an action:", ["Ask a Question", "Record New Arrivals", "Log Sales Transactions", "View Data Visualization"])
...
# 3. Feature: Remove a T-shirt
    ...
    remove_quantity = st.number_input("Enter the quantity to remove:", min_value=1, step=1)
